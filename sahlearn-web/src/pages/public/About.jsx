...
const CREDENTIALS = [
  { icon: Award, label: 'Certified Instructor', desc: 'Professionally trained in digital skills education' },
  { icon: Users, label: 'Hundreds of Students', desc: 'Learners trained across Nigeria' },
  { icon: BookOpen, label: 'Multi-subject', desc: 'Design, Office, AI, Marketing and more' },
  { icon: MessageCircle, label: 'WhatsApp-first', desc: 'Always reachable and responsive' },
];
...
export default function About() {
  return (
    <>
      <SEO title="About" description="Learn about Sahlearn — our mission, our instructor, and the digital skills we teach across Nigeria." url="/about" />
      {/* Hero strip */}
      <section className="bg-white border-b border-ink-300/30 py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-ink-900 font-display">About Sahlearn</h1>
          <p className="text-ink-500 mt-2 text-lg">Our mission, our teacher, and what we teach.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="rounded-2xl overflow-hidden bg-surface-100 h-80 lg:h-[420px] flex items-center justify-center border border-ink-300/40">
              <span className="text-ink-400 text-sm">Teacher photo</span>
            </div>
            <div>
              <span className="text-xs font-semibold text-brand-primary uppercase tracking-wider">Our Instructor</span>
              <h2 className="text-2xl md:text-3xl font-bold text-ink-900 font-display mt-2 mb-4">Meet your teacher</h2>
              <div className="space-y-4 text-ink-700 leading-relaxed">
                <p>
                  Sahlearn was founded with a simple belief: every Nigerian deserves access to practical, affordable digital skills training. Our instructor brings years of hands-on experience to every lesson.
                </p>
                <p>
      ...
      <section className="bg-white border-y border-ink-300/30 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-bold text-ink-900 font-display text-center mb-10">Why trust Sahlearn?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {CREDENTIALS.map(({ icon: Icon, label, desc }) => (
              <div key={label} className="text-center p-6 rounded-xl border border-ink-300/40 hover:shadow-md transition-shadow">
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-bold text-ink-900 font-display mb-2">What we teach</h2>
      ...
      <section className="bg-brand-primary py-14 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white font-display mb-3">Have questions?</h2>
          <p className="text-blue-100 mb-8">Reach out and we'll respond within 24 hours.</p>
